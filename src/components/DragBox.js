...
class Scene extends React.Component {
  ...
  componentDidMount() {
    ...
    World.add(engine.world, [
     ...
     World.add(engine.world, [
       Bodies.circle(10, 225, 20, {
         restitution: 0,
         render: { fillStyle: "#7C3A2E" }
       }),
       Bodies.rectangle(100, 225, 100, 100, {
         restitution: 0,
         render: { fillStyle: "#C25822" }
       }),
       Bodies.circle(100, 255, 40, {
         restitution: 0,
         render: { fillStyle: "#7C3A2E" }
       }),
       Bodies.rectangle(180, 220, 80, 80, {
         restitution: 0,
         render: { fillStyle: "#ECD7C9" }
       }),
       Bodies.rectangle(240, 225, 40, 40, {
         restitution: 0,
         render: { fillStyle: "#7C3A2E" }
       }),
       Bodies.circle(260, 225, 30, {
         restitution: 0,
         render: { fillStyle: "#C25822" }
       })
     ]);
  ...
  render() {
    return (
      <Card
      className="border-solid border-zinc-200 border-[8px] rounded-3xl h-[476px] w-[388px] relative overflow-hidden will-change-transform"
    >
    <div ref="scene" />;
    </Card>
    )
